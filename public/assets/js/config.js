...
window.CONFIG = {
   ...
   * note    : 제목 옆에 붙는 작은 글씨 (없으면 생략)
   * place   : 그 순서가 열리는 장소 이름
   * address : 장소 주소
   * kakaoMapUrl / naverMapUrl : 적으면 그 줄 아래에 지도 링크가 생깁니다
   * 통째로 지우거나 [] 로 두면 일정 섹션이 화면에서 사라집니다.
   */
  schedule: [
    { time: '14:00 ~ 16:00', title: '도안호수풋살파크 집결/풋살' },
    { time: '16:00 ~ 17:00', title: '이동 및 샤워' },
    {
      time: '17:30 ~ 21:30',
      title: '동창회 1부',
      place: '꼬지삼형제 둔산본점',
      address: '대전 서구 문정로 89번길 32 1층',
      kakaoMapUrl: 'https://map.kakao.com/?q=꼬지삼형제 둔산본점',
      naverMapUrl: 'https://map.naver.com/p/search/꼬지삼형제 둔산본점'
    },
   ...
   */
  kakaoMapUrl: 'https://map.kakao.com/?q=도안호수풋살파크',
  naverMapUrl: 'https://map.naver.com/p/search/도안호수풋살파크',
  ...
  greeting: [
    ...
    '',                                        // 빈 줄
    '선으로서 삶을 이겨나가는 것이',
    '얼마나 힘든 것인지 느껴가고 있는 요즘,',
    '희미해져가는 여러분들의 아름다운 웃음을',
    '다시 함께하고 싶어 자리를 마련했습니다.'
  ],
